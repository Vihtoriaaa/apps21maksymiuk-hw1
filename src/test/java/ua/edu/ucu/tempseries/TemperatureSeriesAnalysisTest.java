...
public class TemperatureSeriesAnalysisTest {
    ...
    public void testClosestToValue() {
        ...
        double actualResult = seriesAnalysis.findTempClosestToValue(3.33);
        assertEquals(expResult, actualResult, 0.00001);
    }
    ...
    public void testClosestToValueWithEmptyArray() {
        double[] temperatureSeries = {};
        TemperatureSeriesAnalysis seriesAnalysis = new TemperatureSeriesAnalysis(temperatureSeries);
        seriesAnalysis.findTempClosestToValue(3.33);
    }
    ...
    public void testTempsLessThen() {
        ...
        double[] actualResult = seriesAnalysis.findTempsLessThen(4.564);
    ...
    public void testTempsLessThenWithEmptyArray() {
        double[] temperatureSeries = {};
        TemperatureSeriesAnalysis seriesAnalysis = new TemperatureSeriesAnalysis(temperatureSeries);
        seriesAnalysis.findTempsLessThen(4.564);
    }

    @Test
    public void testTempsLessThenWithOneElement() {
        double[] temperatureSeries = {-1.0};
        TemperatureSeriesAnalysis seriesAnalysis = new TemperatureSeriesAnalysis(temperatureSeries);
        double[] expResult = {-1.0};
        double[] actualResult = seriesAnalysis.findTempsLessThen(4.564);
    ...
    public void testTempsGreaterThen() {
        ...
        double[] actualResult = seriesAnalysis.findTempsGreaterThen(2.999);
        assertArrayEquals(expResult, actualResult, 0.00001);
    }
    ...
    public void testTempsGreaterThenWithEmptyArray() {
        double[] temperatureSeries = {};
        TemperatureSeriesAnalysis seriesAnalysis = new TemperatureSeriesAnalysis(temperatureSeries);
        seriesAnalysis.findTempsGreaterThen(2.999);
    }

    @Test
    public void testTempsGreaterThenWithOneElement() {
        double[] temperatureSeries = {-1.0};
        TemperatureSeriesAnalysis seriesAnalysis = new TemperatureSeriesAnalysis(temperatureSeries);
        double[] expResult = {};
        double[] actualResult = seriesAnalysis.findTempsGreaterThen(2.999);
    ...
    public void testSummaryStatistics() {
        double[] temperatureSeries = {3.0, -5.0, 1.0, 5.0};
        TemperatureSeriesAnalysis seriesAnalysis = new TemperatureSeriesAnalysis(temperatureSeries);
        String expResult = "TempSummaryStatistics{average_temperature=1.0 | deviation_temperature=3.7416573867739413 | min_temperature=-5.0 | max_temperature=5.0}";
    ...
    public void testSummaryStatisticsWithOneElement() {
        double[] temperatureSeries = {-1.0};
        TemperatureSeriesAnalysis seriesAnalysis = new TemperatureSeriesAnalysis(temperatureSeries);
        String expResult = "TempSummaryStatistics{average_temperature=-1.0 | deviation_temperature=0.0 | min_temperature=-1.0 | max_temperature=-1.0}";
        String actualResult = seriesAnalysis.summaryStatistics().toString();
        assertEquals(expResult, actualResult);
    }
    ...
    public void testAddTemps() {
        double[] temperatureSeries = {3.0, -5.0, 1.0, 5.0};
        double[] valuesToAdd = {6.5, 8.0, -10.5};
        TemperatureSeriesAnalysis seriesAnalysis = new TemperatureSeriesAnalysis(temperatureSeries);
        int expResult = 7;
        int actualResult = seriesAnalysis.addTemps(valuesToAdd);
        assertEquals(expResult, actualResult, 0.00001);
    }
